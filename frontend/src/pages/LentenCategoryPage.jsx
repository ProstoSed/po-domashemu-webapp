/**
 * LentenCategoryPage — товары внутри постной категории.
 * Аналог CategoryPage, но использует useLentenPrices.
 */
...
export default function LentenCategoryPage() {
    const { categoryKey } = useParams()
    const navigate = useNavigate()
    const { getCategory, loading } = useLentenPrices()
    ...
    return (
        <div className="category-page">
            <motion.button
                ...
                whileTap={{ scale: 0.95 }}
            >
                <span className="back-arrow">←</span> Постная выпечка
            </motion.button>
