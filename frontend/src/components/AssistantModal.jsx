...
const HINT_POOL = [
    ...
    'Хочу десерт на вечеринку',
    'Что взять на корпоратив?',
    'Посоветуйте перекус в дорогу',
    'Что заказать на 8 марта?',
    'Нужен подарок учителю',
    'Что есть из рыбных пирогов?',
    'Хочу что-то лёгкое и нежное',
    'Что заказать на Новый год?',
    'Посоветуйте выпечку для детей',
    'Что взять на природу с друзьями?',
    'Нужен пирог на каждый день',
    'Что есть с творогом?',
    'Хочу сытный обед из выпечки',
    'Что подойдёт на завтрак семье?',
    'Посоветуйте что-то необычное',
    'Что заказать маме на день рождения?',
    'Есть что-нибудь диетическое?',
    'Хочу пиццу домашнюю',
    'Что взять на чаепитие с подругами?',
    'Нужна выпечка на поминки',
    'Что заказать на крестины?',
    'Посоветуйте сладости без глютена',
    'Хочу попробовать фуршетное меню',
    'Что есть с грибами?',
    'Нужен торт без мастики',
    'Что подарить на новоселье?',
    'Посоветуйте булочки к школьному чаю',
    'Что взять на день рождения ребёнку?',
    'Хочу заказать на масленицу',
]
