/**
 * useLentenPrices — загрузка постного меню.
 * Аналог usePrices, но запрашивает /api/lenten-prices.
 * Нет static fallback (постное меню только из API).
 */
...
export function useLentenPrices() {
